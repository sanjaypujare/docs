...
* Import or download the most-recent version of existing application packages **Note**: After importing or downloading applications or libraries, you can use them just like you used to before. For example, you can perform operations such as launching the application, editing the application, cloning the application, and deleting the application. 
